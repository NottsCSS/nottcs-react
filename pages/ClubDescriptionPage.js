...
import { CLUB_LIST_SECONDARY_ACCENT } from "../assets/AppConstants";
        ...
        return (
            <View style={ClubDescriptionPageStyle.container}>
                {this.state.club ? (
                    <View style={ClubDescriptionPageStyle.container}>
                        <Image
                            source={{ uri: this.state.club.icon }}
                            style={ClubDescriptionPageStyle.image}
                        />
                        <ScrollView
                            style={ClubDescriptionPageStyle.container}
                            contentContainerStyle={
                                ClubDescriptionPageStyle.textView
                            }
                        >
                            <Text style={ClubDescriptionPageStyle.title}>
                                {this.state.club.name}
                            </Text>
                            <Text style={ClubDescriptionPageStyle.description}>
                        ...
                        <Button
                            ...
                            color={CLUB_LIST_SECONDARY_ACCENT}
                        />
                    </View>
                ) : (
                    <LoadingPage />
